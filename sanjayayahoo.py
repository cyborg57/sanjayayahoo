...
def banner():
    print " "
    runntxt(GL+"              SanjayaDtm")
    print GG+"√==========================================√"
    print GL+"   |••••••   TOOLS YAHOO CLONING  ••••••| "
    print GG+"√==========================================√"
    print WW+"  |  DECOMPILED BY: SanjayaDtm            |"
    print GL+"  |       Khusus Fb yang Kerad bisa guna ni       |"
    print WW+"  |            FACEBOOK: SanjayaDtm            |"
    print Y+"  |             WhatsApp: 083197998878              |"
    print GL+"  |---------------------------------------------|"
    print GL+"  | Github: sanjayaajo         |"
    print GL+"  |---------------------------------------------|"
    print GG+"  √=============================================√"
...
print wd+"         https://www.github.com/sanjayaajo "
reload(sys)
